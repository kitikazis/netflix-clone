...
export class CrearEsquemaInicial1784633390492 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "contenido_generos" ("contenido_id" uuid NOT NULL, "genero_id" uuid NOT NULL, CONSTRAINT "PK_910249c88f4216b16b2829e8dcd" PRIMARY KEY ("contenido_id", "genero_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_08698d8663a5b65a597442b094" ON "contenido_generos" ("contenido_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4dde87bc57255cbf98f0d28e43" ON "contenido_generos" ("genero_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "episodios" ADD CONSTRAINT "FK_37acc83de332c05d7762abd0945" FOREIGN KEY ("contenido_id") REFERENCES "contenido"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "progreso_visualizacion" ADD CONSTRAINT "FK_1894b7860af0368039ca9dbd912" FOREIGN KEY ("perfil_id") REFERENCES "perfiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "progreso_visualizacion" ADD CONSTRAINT "FK_de29adc5458e4cd046622c00026" FOREIGN KEY ("contenido_id") REFERENCES "contenido"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "progreso_visualizacion" ADD CONSTRAINT "FK_262e84bdc878ac83eb42b90c4f8" FOREIGN KEY ("episodio_id") REFERENCES "episodios"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "contenido_generos" ADD CONSTRAINT "FK_08698d8663a5b65a597442b0945" FOREIGN KEY ("contenido_id") REFERENCES "contenido"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "contenido_generos" ADD CONSTRAINT "FK_4dde87bc57255cbf98f0d28e434" FOREIGN KEY ("genero_id") REFERENCES "generos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "contenido_generos" DROP CONSTRAINT "FK_4dde87bc57255cbf98f0d28e434"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contenido_generos" DROP CONSTRAINT "FK_08698d8663a5b65a597442b0945"`,
    );
    await queryRunner.query(
      `ALTER TABLE "perfiles" DROP CONSTRAINT "FK_f1ba88813b103ae277538c3fdd8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "progreso_visualizacion" DROP CONSTRAINT "FK_262e84bdc878ac83eb42b90c4f8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "progreso_visualizacion" DROP CONSTRAINT "FK_de29adc5458e4cd046622c00026"`,
    );
    await queryRunner.query(
      `ALTER TABLE "progreso_visualizacion" DROP CONSTRAINT "FK_1894b7860af0368039ca9dbd912"`,
    );
    await queryRunner.query(
      `ALTER TABLE "episodios" DROP CONSTRAINT "FK_37acc83de332c05d7762abd0945"`,
    );
